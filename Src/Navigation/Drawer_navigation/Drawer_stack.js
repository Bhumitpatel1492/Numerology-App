...
const Drawer_stack = ({navigation}) => {
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen name="ReportDriver" component={ReportDriver} />
      <Drawer.Screen
      ...
      <Drawer.Screen name="WellPowerYog" component={WellPowerYog} />
